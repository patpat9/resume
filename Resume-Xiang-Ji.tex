...
{\bf Software Engineer -- Google} \hfill 2014.10 -- present \\
Maple: Health Data Labeling Platform
\begin{itemize} \itemsep -2pt
\item Tech Lead Manager, responsible for health data labeling needs across Alphabet
\end{itemize}

Actions on Google (AoG): third party developer platform for Google Assistant
\begin{itemize} \itemsep -2pt
\item Launched AoG console backend
\end{itemize}

Firebase: Google's mobile focused platform for third party developers
\begin{itemize} \itemsep -2pt
\item Launched Firebase console backend
\end{itemize}
